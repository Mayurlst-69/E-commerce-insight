...
> End-to-end data analytics pipeline — from raw CSV ingestion to an interactive
> business insights dashboard. Built with Python, SQLite, pandas, Streamlit, and Plotly.
> Runs fully locally with a single command.
